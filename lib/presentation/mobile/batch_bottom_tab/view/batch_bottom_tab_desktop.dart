...
class BatchBottomTabDesktop extends StatefulWidget {
  const BatchBottomTabDesktop({super.key});

  @override
  State<BatchBottomTabDesktop> createState() => _BatchBottomTabDesktopState();
}

class _BatchBottomTabDesktopState extends State<BatchBottomTabDesktop> {
  @override
  void initState() {
